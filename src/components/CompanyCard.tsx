      ...
      <div className="company-card-content">
        ...
        <div className="company-categories">
          {company.categorias.slice(0, 2).map((categoria) => (
            <span
              ...
              style={{ backgroundColor: `${getCategoryColor(categoria)}20`, color: getCategoryColor(categoria) }}
            >
        ...
        <div className="company-stage">
          <span
            ...
            style={{ backgroundColor: `${getStageColor(company.etapaDesarrollo)}20`, color: getStageColor(company.etapaDesarrollo) }}
          >
