      ...
      <section className="about-section history-section">
        <div className="container">
          ...
          <div className="history-content">
            <p>
              La Asociación HealthTech del Perú nace de la necesidad de unir y fortalecer el
              ecosistema de tecnología en salud del país. Fundada en 2025, somos la primera
              asociación dedicada exclusivamente a promover la innovación digital en el sector salud
              peruano.
            </p>
            <p>
              En un contexto donde la transformación digital de la salud se vuelve cada vez más
              crucial, nuestra asociación surge para ser el puente entre startups, instituciones de
              salud, reguladores, inversionistas y todos los actores del ecosistema HealthTech.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="mvv-grid">
            ...
            <div className="mvv-card">
              ...
              <p>
                ...
                por promover la innovación responsable, la excelencia regulatoria y la
            ...
            <div className="mvv-card">
              ...
              <ul className="values-list">
                <li>
                  <strong>Innovación:</strong> Promovemos el desarrollo de soluciones disruptivas
                </li>
                <li>
                  <strong>Colaboración:</strong> Fomentamos la cooperación entre todos los actores
                </li>
                <li>
                  <strong>Integridad:</strong> Actuamos con transparencia y ética profesional
                </li>
                <li>
                  <strong>Excelencia:</strong> Buscamos los más altos estándares de calidad
                </li>
                <li>
                  <strong>Impacto Social:</strong> Priorizamos mejorar el acceso a la salud
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="container">
          ...
          <div className="objectives-grid">
            ...
            <div className="objective-card">
              ...
              <p>
                Proveer guías y recursos para navegar la regulación sanitaria (DIGEMID, MINSA) y
            ...
            <div className="objective-card">
              ...
              <p>
                Conectar emprendimientos con inversionistas y facilitar el acceso a capital para
                escalar soluciones de salud digital.
              </p>
            </div>
            <div className="objective-card">
              ...
              <p>
                Producir reportes, estudios y análisis sobre el estado del HealthTech en Perú y
            ...
            <div className="objective-card">
              ...
              <p>
                Apoyar en la validación de soluciones digitales con metodologías y conexiones con
          ...
          <div className="why-join-content">
            <div className="why-join-grid">
              ...
              <div className="why-card">
                ...
                <p>
                  Obtén acceso a guías, templates y asesoría sobre compliance sanitario, protección
                  de datos y certificaciones necesarias.
                </p>
              </div>
              <div className="why-card">
                <h4>Visibilidad y Credibilidad</h4>
                <p>
                  Posiciona tu solución en el directorio oficial, participa en eventos destacados y
                  gana reconocimiento en el ecosistema.
                </p>
              </div>
              <div className="why-card">
                <h4>Acceso a Oportunidades</h4>
                <p>
                  Conecta con hospitales para pilotos, participa en licitaciones, accede a programas
                  de financiamiento y aceleración.
                </p>
              </div>
              <div className="why-card">
                <h4>Formación Continua</h4>
                <p>
                  Participa en la Academia HealthTech con cursos especializados, workshops y
              ...
              <div className="why-card">
                ...
                <p>
                  Forma parte de un movimiento que busca democratizar el acceso a servicios de salud
                  de calidad en todo el Perú.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="about-cta-section">
        <div className="container">
          <div className="about-cta-box">
            ...
            <p>Forma parte del ecosistema que está transformando la salud digital en el Perú</p>
