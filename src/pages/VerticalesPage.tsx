import { Video, Database, Brain, Heart, Building2, Pill, ArrowRight } from 'lucide-react';
  ...
  const verticales: Vertical[] = [
    {
      ...
      icon: <Video />,
      description:
        'Plataformas que permiten consultas médicas a distancia, mejorando el acceso a servicios de salud en todo el Perú.',
      examples: [
    ...
    },
    {
      ...
      icon: <Database />,
      description:
        'Soluciones para la gestión, almacenamiento y análisis seguro de historias clínicas y datos médicos.',
      examples: [
    ...
    },
    {
      ...
      icon: <Brain />,
      description:
        'Tecnologías de inteligencia artificial y machine learning aplicadas al diagnóstico y tratamiento médico.',
      examples: [
    ...
    },
    {
      ...
      icon: <Heart />,
      description:
        'Plataformas especializadas en salud mental, terapia psicológica y bienestar emocional digital.',
      examples: [
    ...
    },
    {
      ...
      icon: <Building2 />,
      description:
        'Software para la administración eficiente de clínicas, hospitales y centros de salud.',
      examples: [
    ...
    },
    {
      ...
      icon: <Pill />,
      description:
        'Plataformas para la venta, entrega y gestión de medicamentos de forma digital y segura.',
      examples: [
      ...
      <section className="verticales-hero">
        <div className="container">
          ...
          <p className="verticales-subtitle">
            Explorá las diferentes categorías de innovación en salud digital que están transformando
            el ecosistema de salud en el Perú
          </p>
        </div>
      </section>
      ...
      <section className="verticales-intro-section">
        <div className="container">
          <div className="intro-content">
            ...
            <p>
              El sector HealthTech abarca un amplio espectro de soluciones tecnológicas aplicadas a
              la salud. Hemos identificado 6 verticales principales que representan las áreas de
              mayor innovación y potencial de impacto en nuestro país.
            </p>
            <p>
              Cada vertical agrupa empresas, startups y soluciones que comparten objetivos
              similares, facilitando la colaboración, el aprendizaje compartido y el desarrollo del
              ecosistema.
            </p>
          </div>
        </div>
        ...
        <div className="container">
          <div className="verticales-grid">
            {verticales.map((vertical, index) => (
              ...
              >
                <div className="vertical-icon-wrapper" style={{ backgroundColor: vertical.color }}>
                  {vertical.icon}
                </div>
      ...
      <section className="more-verticales-section">
        <div className="container">
          <div className="more-verticales-box">
            ...
            <p>
              Además de estas 6 verticales principales, el ecosistema HealthTech incluye otras áreas
              emergentes como:
            </p>
      ...
      <section className="verticales-cta-section">
        <div className="container">
          <div className="verticales-cta-box">
            ...
            <p>Únete a nuestra asociación y conecta con otros innovadores del sector</p>
